...
def to_mod_list(employee_list):
   ...
   employee_dep = map(mod, employee_list)
   print(employee_dep)
   
   return list(employee_dep)
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
#    user_id_init = [(employee['name'][0], employee['id']) for employee in employee_list]
   intitial_by_id = {employee['name'][0] : employee['id']  for employee in employee_list}
#    print(intitial_by_id)
   return intitial_by_id
